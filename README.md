...
가상돔을 활용하여 재사용 가능한 ui 구성 요소를 만들 수 있다.
페이지 전체를 렌더링하지 않고 필요한 부분만 랜더링하기에 사용하였습니다.

## Redux를 사용한 이유

부트캠프에서 미니프로젝트를 하였을 때 Redux를 사용하지 않고 State를 불러서 사용하였는데 여러가지 이슈가 많았다.
더블랜더링이 되기도 하고, State도 많아져 관리하는게 힘들었다.
그래서 Redux가 상태도 관리해주고, 유지보수 측면에서도 좋다고 하기에 사용하게 되었다.
